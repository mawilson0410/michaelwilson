...
const skills = [
  ...
  { name: "DaisyUI", level: 70, category: "frontend" },

  // Backend
  { name: "Java", level: 90, category: "backend" },
  { name: "C++", level: 85, category: "backend" },
  { name: "Python", level: 85, category: "backend" },
  { name: "API Dev", level: 70, category: "backend" },
  { name: "Django", level: 85, category: "backend" },
  { name: "Java Spring", level: 55, category: "backend" },
  { name: "Node.js", level: 85, category: "backend" },
  { name: "Express", level: 75, category: "backend" },
  { name: "MongoDB", level: 85, category: "backend" },
  { name: "TanStack", level: 40, category: "backend" },
  { name: "PostgreSQL", level: 50, category: "backend" },
  { name: "GraphQL", level: 50, category: "backend" },

  // Tools
  { name: "Git/GitHub", level: 95, category: "tools" },
  { name: "AWS, General", level: 75, category: "tools" },
  { name: "AWS, EC2", level: 70, category: "tools" },
  { name: "AWS, Lambda", level: 65, category: "tools" },
  { name: "AWS, Route 53", level: 65, category: "tools" },
  { name: "MS Azure", level: 40, category: "tools" },
  { name: "Docker", level: 45, category: "tools" },
  { name: "Figma", level: 40, category: "tools" },
  { name: "VS Code", level: 95, category: "tools" },
  { name: "Android Studio", level: 85, category: "tools" },
  { name: "MS Word", level: 85, category: "tools" },
