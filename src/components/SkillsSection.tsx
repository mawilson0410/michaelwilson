...
const skills: Skill[] = [
  ...
  { name: "Angular", category: "frontend", experienceLevel: 3 },
  { name: "TypeScript", category: "frontend", experienceLevel: 4 },
  { name: "Tailwind CSS", category: "frontend", experienceLevel: 4 },
  { name: "React Native", category: "frontend", experienceLevel: 3 },
  { name: "Next.js", category: "frontend", experienceLevel: 2 },
  { name: "DaisyUI", category: "frontend", experienceLevel: 4 },
  { name: "Blazor", category: "frontend", experienceLevel: 2 },

  // Backend
  { name: "Java", category: "backend", experienceLevel: 4 },
  { name: "C++", category: "backend", experienceLevel: 4 },
  { name: "C#/.NET", category: "backend", experienceLevel: 3 },
  { name: "Python", category: "backend", experienceLevel: 4 },
  { name: "RESTful API Dev", category: "backend", experienceLevel: 4 },
  { name: "Django", category: "backend", experienceLevel: 4 },
  { name: "Java Spring Boot", category: "backend", experienceLevel: 2 },
  { name: "Node.js", category: "backend", experienceLevel: 4 },
  { name: "Express.js", category: "backend", experienceLevel: 5 },
  { name: "MongoDB", category: "backend", experienceLevel: 4 },
  { name: "TanStack", category: "backend", experienceLevel: 2 },
  { name: "PostgreSQL", category: "backend", experienceLevel: 4 },
  ...
  { name: "MS Azure", category: "tools", experienceLevel: 2 },
  { name: "Docker", category: "tools", experienceLevel: 2 },
  { name: "Figma", category: "tools", experienceLevel: 2 },
  { name: "Cursor", category: "tools", experienceLevel: 4 },
